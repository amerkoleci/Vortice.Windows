...
public partial class ID2D1RenderTarget
{
    ...
    public ID2D1SolidColorBrush CreateSolidColorBrush(in Color color, BrushProperties? brushProperties = null)
    {
    ...
    public void DrawBitmap(ID2D1Bitmap bitmap, float opacity, BitmapInterpolationMode interpolationMode, Rectangle sourceRectangle)
    {
    ...
    /// <param name="interpolationMode">The interpolation mode to use if the bitmap is scaled or rotated by the drawing operation. The default value is <see cref="F:Vortice.Direct2D1.BitmapInterpolationMode.Linear" />.  </param>
    /// <param name="sourceRectangle">The size and position, in device-independent pixels in the bitmap's coordinate space, of the area within the bitmap to be drawn; NULL to draw the entire bitmap.  </param>
    public void DrawBitmap(ID2D1Bitmap bitmap, Rectangle destinationRectangle, float opacity, BitmapInterpolationMode interpolationMode, Rectangle sourceRectangle)
    {
    ...
    public void DrawRectangle(in Rectangle rectangle, ID2D1Brush brush, float strokeWidth)
    {
    ...
    /// <param name="rectangle">The dimensions of the rectangle to draw, in device-independent pixels. </param>
    /// <param name="brush">The <see cref="ID2D1Brush"/> used to paint the rectangle's stroke. </param>
    public void DrawRectangle(in Rectangle rectangle, ID2D1Brush brush)
    {
        RawRectF rect = rectangle;
        DrawRectangle(rect, brush, 1.0f, null);
    }
    ...
    public void FillRectangle(in Rectangle rectangle, ID2D1Brush brush)
    {
        RawRectF rect = rectangle;
    ...
    public void DrawText(string text, IDWriteTextFormat textFormat, Rectangle layoutRect, ID2D1Brush defaultForegroundBrush)
    {
    ...
    public void DrawText(string text, IDWriteTextFormat textFormat, Rectangle layoutRect, ID2D1Brush defaultForegroundBrush, DrawTextOptions options)
    {
        RawRectF rawLayoutRect = layoutRect;
    ...
    public void DrawText(string text, IDWriteTextFormat textFormat, Rectangle layoutRect, ID2D1Brush defaultForegroundBrush, DrawTextOptions options, MeasuringMode measuringMode)
    {
        RawRectF rawLayoutRect = layoutRect;
