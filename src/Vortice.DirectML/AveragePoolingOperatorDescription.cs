...
public partial struct AveragePoolingOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    ...
    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_AVERAGE_POOLING_OPERATOR_DESC::InputTensor']/*" />
    public TensorDescription InputTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_AVERAGE_POOLING_OPERATOR_DESC::OutputTensor']/*" />
    public TensorDescription OutputTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_AVERAGE_POOLING_OPERATOR_DESC::Strides']/*" />
    public int[] Strides { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_AVERAGE_POOLING_OPERATOR_DESC::WindowSize']/*" />
    public int[] WindowSize { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_AVERAGE_POOLING_OPERATOR_DESC::StartPadding']/*" />
    public int[] StartPadding { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_AVERAGE_POOLING_OPERATOR_DESC::EndPadding']/*" />
    public int[] EndPadding { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_AVERAGE_POOLING_OPERATOR_DESC::IncludePadding']/*" />
    public bool IncludePadding { get; set; }

    /// <inheritdoc></inheritdoc>/>
    public override string ToString() => $"AveragePooling: IncludePadding={IncludePadding}";
