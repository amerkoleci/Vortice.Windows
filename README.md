...
This library targets **.net9.0** and **.net10.0** and uses modern C#, see [CHANGELOG](https://github.com/amerkoleci/Vortice.Windows/blob/main/CHANGELOG.md) for list of changes between commits.
