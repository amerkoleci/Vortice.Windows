...
public partial struct ElementWiseLogicalLessThanOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    ...
    /// </summary>
    public OperatorType OperatorType => OperatorType.ElementWiseLogicalLessThan;

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OPERATOR_DESC::ATensor']/*" />
    public TensorDescription ATensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OPERATOR_DESC::BTensor']/*" />
    public TensorDescription BTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OPERATOR_DESC::OutputTensor']/*" />
    public TensorDescription OutputTensor { get; set; }

    /// <inheritdoc></inheritdoc>/>
    public override string ToString() => $"ElementWiseLogicalLessThan";
