...
public partial struct ElementWiseLogicalGreaterThanOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    ...
    /// </summary>
    public OperatorType OperatorType => OperatorType.ElementWiseLogicalGreaterThan;

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_LOGICAL_GREATER_THAN_OPERATOR_DESC::ATensor']/*" />
    public TensorDescription ATensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_LOGICAL_GREATER_THAN_OPERATOR_DESC::BTensor']/*" />
    public TensorDescription BTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_LOGICAL_GREATER_THAN_OPERATOR_DESC::OutputTensor']/*" />
    public TensorDescription OutputTensor { get; set; }

    /// <inheritdoc></inheritdoc>/>
    public override string ToString() => $"ElementWiseLogicalGreaterThan";
