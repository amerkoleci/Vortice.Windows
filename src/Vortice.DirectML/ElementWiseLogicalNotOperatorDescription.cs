...
public partial struct ElementWiseLogicalNotOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    ...
    /// </summary>
    public OperatorType OperatorType => OperatorType.ElementWiseLogicalNot;

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_LOGICAL_NOT_OPERATOR_DESC::InputTensor']/*" />
