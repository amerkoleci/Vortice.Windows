...
public partial struct BatchNormalizationTrainingGradOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    /// <summary>
    /// Gets the type of operator description.
    /// </summary>
    public OperatorType OperatorType => OperatorType.BatchNormalizationTrainingGrad;

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::InputTensor']/*" />
    public TensorDescription InputTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::InputGradientTensor']/*" />
    public TensorDescription InputGradientTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::MeanTensor']/*" />
    public TensorDescription MeanTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::VarianceTensor']/*" />
    public TensorDescription VarianceTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::ScaleTensor']/*" />
    public TensorDescription ScaleTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::OutputGradientTensor']/*" />
    public TensorDescription OutputGradientTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::OutputScaleGradientTensor']/*" />
    public TensorDescription OutputScaleGradientTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC::OutputBiasGradientTensor']/*" />
