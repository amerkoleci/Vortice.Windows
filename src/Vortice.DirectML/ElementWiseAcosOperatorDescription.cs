...
public partial struct ElementWiseAcosOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    ...
    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_ACOS_OPERATOR_DESC::InputTensor']/*" />
    public TensorDescription InputTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_ACOS_OPERATOR_DESC::OutputTensor']/*" />
    public TensorDescription OutputTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_ACOS_OPERATOR_DESC::ScaleBias']/*" />
    public ScaleBias? ScaleBias { get; set; }

    /// <inheritdoc></inheritdoc>/>
    public override string ToString() => $"ElementWiseAcos";
