...
This library targets **.net7.0** and **.net8.0** and uses modern C# 11, see [CHANGELOG](https://github.com/amerkoleci/Vortice.Windows/blob/main/CHANGELOG.md) for list of changes between commits.
