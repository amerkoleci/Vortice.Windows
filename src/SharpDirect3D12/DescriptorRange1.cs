...
namespace SharpDirect3D12
{
    ...
    public partial struct DescriptorRange1
    {
        ...
        /// <param name="descriptorCount">The number of descriptors in the range. Use -1 or UINT_MAX to specify unbounded size. Only the last entry in a table can have unbounded size.</param>
        ...
        /// <param name="offsetInDescriptorsFromTableStart">The offset in descriptors from the start of the root signature. This value can be <see cref="DescriptorRange.Append"/>, which indicates this range should immediately follow the preceding range.</param>
