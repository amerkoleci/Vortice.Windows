...
public partial struct DescriptorRange
{
    ...
    public DescriptorRange(DescriptorRangeType rangeType, uint numDescriptors, uint baseShaderRegister, uint registerSpace = 0, uint offsetInDescriptorsFromTableStart = D3D12.DescriptorRangeOffsetAppend)
    {
        RangeType = rangeType;
