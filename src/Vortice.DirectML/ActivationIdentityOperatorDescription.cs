...
public partial struct ActivationIdentityOperatorDescription : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
{
    /// <summary>
    ...
    public override string ToString() => $"ActivationIdentity";
