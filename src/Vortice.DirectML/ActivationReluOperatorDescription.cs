...
public partial struct ActivationReluOperatorDescription : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
{
    /// <summary>
    ...
    public override string ToString() => $"ActivationRelu";
