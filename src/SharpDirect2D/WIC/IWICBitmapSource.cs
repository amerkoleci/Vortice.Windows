...
namespace SharpDirect2D.WIC
{
    public partial class IWICBitmapSource
    {
        ...
        public unsafe void CopyPixels(Rect rectangle, int stride, int size, IntPtr data)
        {
            Guard.MustBeGreaterThan(size, 0, "Size must be greather than 0");
            Guard.MustBeGreaterThan(stride, 0, "Stride must be greather than 0");
        ...
        public unsafe void CopyPixels(Rect rectangle, int stride, byte[] data)
        {
            Guard.MustBeGreaterThan(stride, 0, "Stride must be greather than 0");
            Guard.NotNullOrEmpty(data, nameof(data));
        ...
        public unsafe void CopyPixels<T>(Rect rectangle, int stride, T[] data) where T : struct
        {
            Guard.MustBeGreaterThan(stride, 0, "Stride must be greather than 0");
            Guard.NotNullOrEmpty(data, nameof(data));
