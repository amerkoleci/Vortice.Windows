...
public partial class AutoBreadcrumbNode1
{
    ...
    internal unsafe struct __Native
    {
        ...
        public int BreadcrumbContextsCount;
    ...
    internal unsafe void __MarshalFrom(__Native* @ref)
    {
        ...
        if (@ref->BreadcrumbContextsCount > 0)
        {
            ...
            for(int i = 0; i < BreadcrumbContextsCount; i++)
            {
                BreadcrumbContexts[i].__MarshalFrom(ref @ref->pBreadcrumbContexts[i]);
            }
        }
    }
