...
public partial struct ActivationSoftsignOperatorDescription : IFusableActivationOperatorDescription, IOperatorDescriptionMarshal
{
    /// <summary>
    ...
    public override string ToString() => $"ActivationSoftsign";
