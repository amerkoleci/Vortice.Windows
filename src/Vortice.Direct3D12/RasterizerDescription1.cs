...
public partial struct RasterizerDescription1
{
    ...
    /// </summary>
    public static readonly RasterizerDescription1 CullClockwise = new(CullMode.Front, FillMode.Solid);

    /// <summary>
    /// A built-in description with settings for culling primitives with counter-clockwise winding order.
    /// </summary>
    public static readonly RasterizerDescription1 CullCounterClockwise = new(CullMode.Back, FillMode.Solid);

    /// <summary>
    /// A built-in description with settings for not culling any primitives and wireframe fill mode.
    /// </summary>
    public static readonly RasterizerDescription1 Wireframe = new(CullMode.Back, FillMode.Wireframe);
