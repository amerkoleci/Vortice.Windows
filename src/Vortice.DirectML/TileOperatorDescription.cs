...
public partial struct TileOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    ...
    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_TILE_OPERATOR_DESC::InputTensor']/*" />
    public TensorDescription InputTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_TILE_OPERATOR_DESC::OutputTensor']/*" />
