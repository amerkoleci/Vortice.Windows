...
public unsafe partial class D3D9
{
    ...
    public static IDirect3D9 Direct3DCreate9On12(D3D9On12Arguments[] overrides)
    {
        ...
        return Direct3DCreate9On12(SdkVersion, overrideList, overrides.Length);
    }
    ...
    public static IDirect3D9Ex Direct3DCreate9On12Ex(D3D9On12Arguments[] overrides)
    {
        ...
        Direct3DCreate9On12Ex(SdkVersion, overrideList, overrides.Length, out IDirect3D9Ex outputInterface).CheckError();
    ...
    public static Result Direct3DCreate9On12Ex(D3D9On12Arguments[] overrides, out IDirect3D9Ex? outputInterface)
    {
        ...
        return Direct3DCreate9On12Ex(SdkVersion, overrideList, overrides.Length, out outputInterface);
    }
}
