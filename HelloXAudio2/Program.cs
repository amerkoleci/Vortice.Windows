...
public static class Program
{
    static async Task Main()
    {
        ...
        IXAudio2 audio = XAudio2.XAudio2Create(ProcessorSpecifier.DefaultProcessor);
        ...
        IXAudio2MasteringVoice masterVoice = audio.CreateMasteringVoice();

        // Define wave format.
        WaveFormatExtensible format = new(96000, 24, 2);

        // Create source voice for buffer submission.
        IXAudio2SourceVoice voice = audio.CreateSourceVoice(format, false);
        ...
        AudioBuffer effectBuffer = new(soundStream.ToDataStream());
