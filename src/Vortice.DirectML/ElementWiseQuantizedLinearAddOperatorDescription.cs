...
public partial struct ElementWiseQuantizedLinearAddOperatorDescription : IOperatorDescription, IOperatorDescriptionMarshal
{
    ...
    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::ATensor']/*" />
    public TensorDescription ATensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::AScaleTensor']/*" />
    public TensorDescription AScaleTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::AZeroPointTensor']/*" />
    public TensorDescription? AZeroPointTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::BTensor']/*" />
    public TensorDescription BTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::BScaleTensor']/*" />
    public TensorDescription BScaleTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::BZeroPointTensor']/*" />
    public TensorDescription? BZeroPointTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::OutputScaleTensor']/*" />
    public TensorDescription OutputScaleTensor { get; set; }

    /// <include file="Documentation.xml" path="/comments/comment[@id='DML_ELEMENT_WISE_QUANTIZED_LINEAR_ADD_OPERATOR_DESC::OutputZeroPointTensor']/*" />
