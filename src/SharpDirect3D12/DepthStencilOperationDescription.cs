...
namespace SharpDirect3D12
{
    public partial struct DepthStencilOperationDescription
    {
        ...
        /// </summary>
        public static readonly DepthStencilOperationDescription Default = new DepthStencilOperationDescription(StencilOp.Keep, StencilOp.Keep, StencilOp.Keep, ComparisonFunction.Always);
        ...
        public DepthStencilOperationDescription(StencilOp stencilFailOp, StencilOp stencilDepthFailOp, StencilOp stencilPassOp, ComparisonFunction stencilFunc)
        {
